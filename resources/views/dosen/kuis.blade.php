...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 p-4 bg-white rounded-2xl shadow-sm border border-gray-100 gap-3">
    <div>
        <h4 class="font-bold text-gray-800 mb-0 text-lg md:text-xl"><i class="bi bi-patch-question-fill text-purple-600 me-2"></i>Bank Soal & Kuis</h4>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition h-100 d-flex flex-column">
                <div class="p-4 flex-grow-1">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <span class="badge bg-purple-50 text-purple-600 border border-purple-100 rounded-lg px-2 py-1 text-[10px] uppercase font-bold">
                            {{ $q->course->nama_mk }}
                        </span>
                        <div class="dropdown">
                ...
                <div class="p-3 border-top bg-gray-50 rounded-b-2xl">
                    <button class="btn btn-purple w-100 rounded-xl font-bold text-sm py-2 shadow-sm text-white" 
...
@else
    <div class="text-center py-5">
        ...
        <a href="{{ url('/dosen/materi') }}" class="btn btn-outline-primary btn-sm rounded-xl mt-2">Ke Susun Materi</a>
    </div>
@endif
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content rounded-2xl border-0 shadow-2xl h-[90vh]">
            ...
            <div class="modal-header border-bottom bg-white p-4">
                <div>
                    <h5 class="modal-title font-bold text-gray-800"><i class="bi bi-collection-play me-2 text-purple-600"></i>{{ $q->judul_materi }}</h5>
                    <p class="mb-0 text-xs text-gray-400">Total Soal: <strong class="text-purple-600">{{ $q->questions_count }}</strong></p>
                </div>
                                    ...
                                    <div class="bg-white p-3 rounded-xl border border-gray-100 shadow-sm group relative">
                                        <div class="d-flex justify-content-between gap-2">
                                            <div class="flex-grow-1">
                                                <p class="font-bold text-gray-800 text-sm mb-2"><span class="text-purple-500 me-1">#{{ $loop->iteration }}</span> {{ $soal->pertanyaan }}</p>
                    ...
                    <div class="col-lg-5 bg-white h-100 overflow-auto">
                        <div class="p-4">
                            <div class="bg-purple-50 p-3 rounded-xl mb-4 border border-purple-100">
                                <h6 class="font-bold text-purple-700 text-sm mb-1"><i class="bi bi-plus-circle me-1"></i> Tambah Soal Baru</h6>
                                <p class="text-[10px] text-purple-600 mb-0">Isi pertanyaan dan opsi jawaban di bawah ini.</p>
                            </div>
                            ...
                            <form action="{{ url('/dosen/soal') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="pertanyaan" class="form-control rounded-xl bg-gray-50 border-0 focus:bg-white focus:ring-2 ring-purple-100 transition" rows="3" required placeholder="Tulis pertanyaan..."></textarea>
                                </div>
                                ...
                                <button type="submit" class="btn btn-primary w-100 py-2 rounded-xl font-bold shadow-lg hover:shadow-xl transition">
