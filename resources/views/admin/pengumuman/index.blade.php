...
@section('content')
    {{-- HEADER: Responsif (Mirip halaman Prodi) --}}
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        ...
        {{-- Tombol Responsif: Full di HP (w-full), Auto di Desktop (md:w-auto) --}}
                    ...
                    @forelse($pengumuman as $item)
                        <tr>
                            ...
                            <td class="text-end px-4">
                                {{-- Tombol Edit --}}
                                <button class="btn btn-sm btn-light text-blue-600 border rounded-lg hover:bg-blue-50 transition" 
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content rounded-xl border-0 shadow-lg">
                                    <div class="modal-header border-bottom-0 pb-0">
                                        <h5 class="modal-title font-bold text-gray-800">Edit Pengumuman</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <select name="tipe" class="form-select text-sm">
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-xl border-0 shadow-lg">
                <div class="modal-header border-bottom-0 pb-0">
                    <h5 class="modal-title font-bold text-gray-800">Buat Pengumuman Baru</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <form action="{{ url('/admin/pengumuman') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label text-xs font-bold text-gray-500 uppercase">Isi Pesan</label>
                            <textarea name="isi" class="form-control" rows="4" placeholder="Tulis detail informasi di sini..." required></textarea>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="modal-footer border-top-0 pt-0">
                        <button type="button" class="btn btn-light text-sm font-bold" data-bs-dismiss="modal">Batal</button>
                        <button type="submit" class="btn btn-primary bg-blue-900 border-0 text-sm font-bold">Terbitkan</button>
                    </div>
                </form>
            </div>
        </div>
